...
const listChannel = async () => {
    const response = await axios.get("https://us.youtubers.me/united-states/all/top-1000-youtube-channels-in-united-states");
    const regex = /<a[^>]*href="([^"]*\/youtuber-stats")[^>]*>([\s\S]*?)<\/a>/g;
